...
function getArticleShareUrl(article){
  ...
  if(article?.staticUrl) return article.staticUrl;
  ...
  shell.innerHTML = `
    ...
    <aside class="article-sidebar">
      ...
      <div class="share article-share-actions">
        ...
        <a href="${facebookShareUrl}" target="_blank" rel="noopener noreferrer" data-share-facebook class="share-btn share-btn-facebook" title="Compartir en Facebook" aria-label="Compartir en Facebook">f</a>
        <a href="${whatsappShareUrl}" target="_blank" rel="noopener noreferrer" data-share-whatsapp class="share-btn share-btn-whatsapp" title="Compartir en WhatsApp" aria-label="Compartir en WhatsApp">WA</a>
      </div>
